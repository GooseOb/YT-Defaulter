...
const getChannelUsername = () => document
...
const onPageChange = async () => {
	...
	const div = getElCreator("div"), input = getElCreator("input"), checkbox = (props) => input({ type: "checkbox", ...props }), option = getElCreator("option"), _label = getElCreator("label"), labelEl = (forId, props) => {
		...
		return elem;
	}, selectEl = getElCreator("select"), btnClass = "yt-spec-button-shape-next", _button = getElCreator("button"), button = (text, props) => _button({
		textContent: text,
